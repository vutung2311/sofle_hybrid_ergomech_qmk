 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |       |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+-------|
 * | Esc  | Ins  | Pscr | Menu |      |      |                    |      | PWrd |  Up  | NWrd | DLine|       |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+-------|
 * | Tab  | LAt  | LCtl |LShift|      |      |-------.    ,-------|      | Left | Down | Right|  Del | Enter |
 * |------+------+------+------+------+------|  MUTE  |    |      |------+------+------+------+------+-------|
 * |Shift | Undo |  Cut | Copy | Paste|      |-------|    |-------|      | LStr | Home | End  |      | Shift |
 * `-----------------------------------------/       /     \      \------------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | /Space  /       \Space \  |RAISE | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
...
[3] = LAYOUT(
  ...
  _______, KC_LALT,  KC_LCTL,  KC_LSFT,  XXXXXXX, XXXXXXX,                       KC_PGDN,  KC_LEFT, KC_DOWN, KC_RGHT,   KC_DEL, KC_ENT,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [2] = { ENCODER_CCW_CW(KC_PGUP, KC_PGDN), ENCODER_CCW_CW(_______, _______) },
